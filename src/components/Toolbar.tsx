  ...
  return (
    <div style={{ display: "flex", gap: "1rem", padding: "1rem" }}>
      <button
        ...
        onMouseOver={(e:any) => (e.target.style.backgroundColor = "#2563eb")} // Tailwind's hover:bg-blue-600
        onMouseOut={(e:any) => (e.target.style.backgroundColor = "#dc2626")}
      ...
      <button
        ...
        onMouseOver={(e:any) => (e.target.style.backgroundColor = "#4b5563")} // Tailwind's hover:bg-gray-600
        onMouseOut={(e:any) => (e.target.style.backgroundColor = "#6b7280")}
